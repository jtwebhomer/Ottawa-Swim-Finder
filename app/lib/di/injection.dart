...
import '../data/services/backend_sync_service.dart';
...
Future<void> configureDependencies() async {
  ...
  getIt.registerLazySingleton<FacilityCoverageReportService>(
  ...
  getIt.registerLazySingleton<BackendSyncService>(
  ...
  getIt.registerLazySingleton<ScheduleTrustResolver>(

    () => ScheduleTrustResolver(settingsRepo: getIt()),
